...
namespace PokedexReactASP.Infrastructure.Migrations
{
    ...
    [Migration("20260708040631_AddCardRewardGlobalSettings")]
    partial class AddCardRewardGlobalSettings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PokedexReactASP.Domain.Entities.CardRewardGlobalSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("CardRewardGlobalSettings");
                });
            ...
            modelBuilder.Entity("PokedexReactASP.Domain.Entities.GymLeader", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
            ...
            modelBuilder.Entity("PokedexReactASP.Domain.Entities.WildAreaEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<bool?>("AllowLegendary")
                        .HasColumnType("boolean");

                    b.Property<bool?>("AllowMythical")
                        .HasColumnType("boolean");

                    b.PrimitiveCollection<List<string>>("AllowedHabitats")
                        .IsRequired()
                        .HasColumnType("text[]");
                    ...
                    b.PrimitiveCollection<List<string>>("AllowedTypes")
                        .IsRequired()
                        .HasColumnType("text[]");

                    b.PrimitiveCollection<List<string>>("BannedTags")
                        .IsRequired()
                        .HasColumnType("text[]");

                    b.PrimitiveCollection<List<string>>("BannedTypes")
                        .IsRequired()
                        .HasColumnType("text[]");
                    ...
                    b.PrimitiveCollection<List<string>>("PreferredHabitats")
                        .IsRequired()
                        .HasColumnType("text[]");

                    b.PrimitiveCollection<List<string>>("PreferredTags")
                        .IsRequired()
                        .HasColumnType("text[]");

                    b.PrimitiveCollection<List<string>>("PreferredTypes")
                        .IsRequired()
                        .HasColumnType("text[]");
                    ...
                    b.PrimitiveCollection<List<string>>("RequiredAnyTags")
                        .IsRequired()
                        .HasColumnType("text[]");

                    b.PrimitiveCollection<List<string>>("RequiredAnyTypes")
                        .IsRequired()
                        .HasColumnType("text[]");
                    ...
                    b.PrimitiveCollection<List<int>>("SafeFallbackPokemonIds")
                        .IsRequired()
                        .HasColumnType("integer[]");

                    b.PrimitiveCollection<List<string>>("SecondaryAllowedTypes")
                        .IsRequired()
                        .HasColumnType("text[]");
                    ...
                    b.ToTable("WildAreaConfigs");
                });

            modelBuilder.Entity("PokedexReactASP.Domain.Entities.WildAreaGlobalSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("AllowLegendarySpawn")
                        .HasColumnType("boolean");

                    b.Property<int>("MaxAttemptsPerSpawn")
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("SpawnWeights")
                        .IsRequired()
                        .HasColumnType("jsonb");

                    b.HasKey("Id");

                    b.ToTable("WildAreaGlobalSettings");
                });
