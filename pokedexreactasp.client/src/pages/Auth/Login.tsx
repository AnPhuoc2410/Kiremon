...
const LoginForm: React.FC = () => {
  ...
  const handleExternalLoginSuccess = async (
    ...
    try {
      ...
      toast.error(
        getApiErrorMessage(error, `${provider} login failed. Please try again.`),
      );
    } finally {
  ...
  const handleTwoFactorSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error(getApiErrorMessage(error, "Invalid 2FA code. Please try again."));
      setTwoFactorCode("");
    } finally {
      setLoading(false);
    }
        ...
        {requiresTwoFactor ? (
          ...
          <AuthForm onSubmit={handleTwoFactorSubmit} aria-label="2fa form">
            <label
              ...
              style={{ fontSize: 13, color: "#626876" }}
            >
              Authentication Code
            </label>
            <AuthInput
                ...
                render={({ onClick }) => (
                  ...
                  >
                    {socialLoading === "Facebook" ? (
                      ...
                      <>
                        <FacebookIcon /> Start with Facebook
                      </>
                    )}
                  </SocialButton>
                )}
