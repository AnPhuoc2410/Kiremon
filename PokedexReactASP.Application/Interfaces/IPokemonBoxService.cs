...
namespace PokedexReactASP.Application.Interfaces
{
    public interface IPokemonBoxService
    {
        ...
        Task<UserBoxDto> GetBoxDetailsAsync(string userId, int boxId, CancellationToken cancellationToken = default);
        ...
        Task<BatchMoveResultDto> MovePokemonBatchAsync(string userId, BatchMovePokemonDto dto, CancellationToken cancellationToken = default);
