...
const Settings: React.FC = () => {
  ...
  const [currentPokeballSprite, setCurrentPokeballSprite] =
    useState<string>("");
  ...
  useEffect(() => {
    const loadPokeballData = async () => {
      ...
      const sprite = await pokeItemService.getPokeballSpriteByName(
        saved || "timer-ball",
      );
      if (sprite) {
          ...
          <S.ContentArea>
              ...
              <S.SettingItem>
                <S.SettingItemMain>
                  ...
                  <S.SettingItemContent>
                    ...
                    <S.SettingItemDescription>
                      Make your profile visible to other trainers and allow them
                      to see your Pokémon collection.
                    </S.SettingItemDescription>
                  </S.SettingItemContent>
                </S.SettingItemMain>
                <S.SettingItemActions>
            ...
            <S.Section id="appearance">
                ...
                <S.SettingItemMain>
                  ...
                  <S.SettingItemContent>
                    ...
                    <S.ThemeSelector>
                      ...
                      >
                        <p className="ra ra-sun" color="#A78BFA">
                          Light
                        </p>
                      </S.ThemeOption>
                      <S.ThemeOption
                      ...
                      >
                        <p className="ra ra-moon-sun" color="#A78BFA">
                          Dark
                        </p>
                      </S.ThemeOption>
                      <S.ThemeOption
              ...
              <S.SettingItem>
                <S.SettingItemMain>
                  ...
                  <S.SettingItemContent>
                    <S.SettingItemTitle>
                      Scroll-to-Top Pokéball
                    </S.SettingItemTitle>
                    <S.SettingItemDescription>
                      Choose your preferred Pokéball for the scroll-to-top
                      button.
                    </S.SettingItemDescription>
                    <S.PokeballSelector>
                      <S.PokeballPreview>
                      ...
                      <S.ChangeButton
                        onClick={() => setIsPokeballModalOpen(true)}
                      >
                        Change
                      </S.ChangeButton>
                    </S.PokeballSelector>
            ...
            <S.Section id="data">
              ...
              <S.SettingItem>
                <S.SettingItemMain>
                  ...
                  <S.SettingItemContent>
                    ...
                    <S.SettingItemDescription>
                      Download a copy of your Pokémon collection, trainer stats,
                      and account data in JSON format.
                    </S.SettingItemDescription>
                  </S.SettingItemContent>
                </S.SettingItemMain>
                <S.SettingItemActions>
              ...
              <S.SettingItem>
                ...
                <S.SettingItemActions>
                  <S.Button variant="danger">Delete Account</S.Button>
                </S.SettingItemActions>
              </S.SettingItem>
            </S.Section>
