    ...
    <S.Page>
      <S.Card>
        ...
        <S.Form onSubmit={handleSubmit} aria-label="login form">
          ...
          <label htmlFor="password" style={{ fontSize: 13, color: '#626876' }}>Password</label>
          <S.Input
            id="password"
            name="password"
            type="password"
        ...
        <S.Row style={{ marginTop: 16 }}>
          ...
          <S.Text>
            <Link to="/forgot" style={{ color: '#EF4444', fontWeight: 600 }}>Forgot?</Link>
          </S.Text>
        </S.Row>
        ...
        <S.Container>
          <S.SocialButton type="button" aria-label="Sign in with Google" onClick={() => { /* placeholder */ }}>
          ...
          <S.SocialButton type="button" aria-label="Sign in with GitHub" onClick={() => { /* placeholder */ }}>
          ...
          <S.SocialButton type="button" aria-label="Sign in with Facebook" onClick={() => { /* placeholder */ }}>
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20" viewBox="0 0 48 48">
